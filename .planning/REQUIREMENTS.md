...
- [ ] **PIPE-01**: Script genera PNGs de páginas con tablas desde los 16 PDFs regionales usando PyMuPDF
- [ ] **PIPE-02**: PNGs se preservan en `data/snapshots/` con naming consistente (`{region}-tabla-p{N}.png`)
